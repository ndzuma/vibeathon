...
export default function AddPlaceScreen() {
  ...
  async function uploadLocalImage(): Promise<{ storageId: string | null; url: string | null }> {
    if (!imageUri) return { storageId: null, url: null };
    ...
    try {
      ...
      Alert.alert('Upload failed', 'Could not upload image, place will be added without photo.');
      return { storageId: null, url: null };
    } finally {
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      if (imageUri) {
        const r = await uploadLocalImage();
  ...
  const hasImage = imageUri || (imageMode === 'url' && imageUrl.trim());
  ...
  return (
    <View style={[styles.container, { backgroundColor: theme.bg }]}>
      ...
      <View style={[styles.header, { borderBottomColor: theme.border }]}>
        ...
        <Text style={[styles.title, { color: theme.textPrimary }]}>Add a place</Text>
            ...
            {imageUri ? (
              <>
                ...
                <Pressable
                  ...
                  onPress={() => { setImageUri(null); setUploadedStorageId(null); }}
                  hitSlop={8}
                >
          ...
          <View style={styles.form}>
            ...
            <View style={styles.fieldGroup}>
              ...
              <View style={styles.locationRow}>
                ...
                <Pressable
                  style={[styles.locationChip, { borderColor: theme.border, backgroundColor: theme.surface }]}
                  onPress={() => { setPinCoords(null); setMapVisible(true); }}
                >
